...
namespace API.Response.Dynamic.Model.Controllers.V2_DB2400
{
    ...
    // public class DynamicApiController : ControllerBase
    {
            ...
            string _SqlRequest, bool _ClauseWhere, bool _JobSummary, bool _DynamicModel)
        {
            ...
            if (resSql == "")
            {
                ...
                if (statusjob == string.Empty)
                {
                    ...
                    if (statusjob == string.Empty)
                    {
                        ...
                        if (_JobSummary)
                        {
                            ...
                            if (_DynamicModel)
                            {
                                ...
                                result = this.Ok(SJinstanceModel);
                            }
                            ...
                            else
                            {
                                ...
                                result = this.Ok(dynanmicInstance);
                            }
                        }
                        ...
                        {
                            result = this.Ok(OutInstanceMapped);
                        }
                    ...
                    {
                        result = this.BadRequest(statusjob);
                    }
                }
            ...
            string _SqlRequest,string _ModelName, bool _ClauseWhere, bool _JobSummary, bool _DynamicModel)
        {
            ...
            if (resSql == "")
            {
                ...
                ApiDemandRequest DemandRequest = this._repository.AddDemandRequest(new ApiDemandRequest()
                {
                ...
                catch (Exception ex) 
                {
                    ...
                    result = this.BadRequest(sb.ToString());
                    return result;
                }
                ...
                foreach (var Item in propertiesInfos)
                {
                    ...
                    ApiDemandProperties DemandProperties = this._repository.AddDemandProperties(new ApiDemandProperties()
                    {
